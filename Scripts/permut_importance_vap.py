...
def main(**args):
    ...
    #select algorithms
    my_model = ["RandomForestRegressor(random_state=47)", "GradientBoostingRegressor(random_state=47)", "RandomForestRegressor(n_estimators= 250, min_samples_split= 2, min_samples_leaf= 1, max_features='sqrt', max_depth= 35, bootstrap= False, random_state=47)", "GradientBoostingRegressor(n_estimators= 300, min_samples_split= 2, min_samples_leaf= 1, max_features='sqrt', max_depth= 5, random_state=47)"]
